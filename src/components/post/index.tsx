...
export const Post = ({ img, label, title }: IPost) => {
    return (
        <div className="mSM:flex-col w-full flex gap-[1rem] items-center border-b border-[#313131] pb-[1.5rem]">
            ...
            <div className="mSM:w-[100%] mmSD:w-[65%] w-[70%]">
                ...
                <Link to=""><h2 className="mmSD:text-[1.3rem] mmSD:leading-[1.3rem] mSM:text-[1.5rem] mSM:leading-[1.5rem] text-[1.5rem] leading-[1.5rem] text-[#BBB] hover:text-[#02d96d]">{title}</h2></Link>
            </div>
        </div>
    );
}